        ...
        <div class="card-body px-lg-5 pt-0">
            <form class="text-center" action="#" method="post" style="color: #aaa;">
                ...
                <div class="text-center float-right col-md-4 d-block small mt-2">
                    <button class="btn btn-success btn-block btn-lg" id="btnLogin" type="submit">Entrar&nbsp;&nbsp;
                        <i class="fas fa-sign-in-alt fa-lg"></i>
                    </button> <!-- ./text-center float-right col-md-6 d-block small mt-2 -->
                </div>

                <div class="text-center float-right col-md-4 d-block small mt-2">
                    <a class="btn btn-warning btn-block btn-lg" data-toggle="modal" data-target="#modalRegisterForm" id="btnRegistrar">Registrar&nbsp;&nbsp;
                ...
                <div class="modal-body mx-3">
                    <form action="#" method="post" style="color: #aaa;">
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="Nome Completo" maxlength="250" length="250" name="registerNomeCompleto" required id="pes_nome" class="form-control">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-6 -->
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="email" placeholder="Email" maxlength="250" length="250" required id="pesEmailRegister" name="pes_login" class="form-control">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-6 -->
                        </div> <!-- ./End form-row -->
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="CEP" class="form-control pesCep" maxlength="9" name="pesCep" required id="end_cep" autocomplete="on">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-4 -->
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="Endereço" maxlength="250" length="250" class="form-control" required name="pesEndereco" id="end_endereco"
                                           autocomplete="on">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-4 -->
                        </div> <!-- ./End form-row -->
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="Número" maxlength="20" class="form-control" required name="pesNumero" id="end_numero" autocomplete="on">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-4 -->
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="Cidade" maxlength="250" length="250" class="form-control" required name="pesCidade" id="cid_cidade"
                                           autocomplete="on">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-4 -->
                        </div> <!-- ./End form-row -->
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="UF" min="2" maxlength="2" length="2" class="form-control" name="pesEstado" required id="est_sigla"
                                           autocomplete="on">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-4 -->
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="text" placeholder="Bairro" class="form-control" name="pesBairro" maxlength="250" length="250" required id="end_bairro"
                                           autocomplete="on">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-4 -->
                        </div> <!-- ./End form-row -->
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="password" placeholder="Senha" minlength="8" maxlength="32" length="32" required name="registrarSenhaUsuario" id="pes_senha"
                                           class="form-control">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-6 -->
                            <div class="col-md-6">
                                <div class="md-form">
                                    <input type="password" placeholder="Repetir senha" minlength="8" maxlength="32" length="32" required name="repetirRegistrarsenhaUsuario"
                                           id="pes_repetirSenha" onblur="verificaSenha()" class="form-control">
                                </div> <!-- ./End md-form -->
                            </div> <!-- ./End col-md-6 -->
                        </div> <!-- ./End form-row -->
...
<main>
    <div class="modal animated bounceIn" id="modalRecupeForm" tabindex="-1" role="dialog" aria-labelledby="modalRecuperarConta" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fluid container" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    <form class="text-center" action="#" method="POST" style="color: #aaa;">
                        ...
                        <div class="text-center col-md-7 mt-2">
