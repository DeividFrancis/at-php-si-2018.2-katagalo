                  ...
                  <form class="text-center" action="#" method="POST" style="color: #aaa;">
                        ...
                        <div class="form-row">
                              <div class="col-md-6">
                                    <!-- CPF -->
                                    <div class="md-form">
                                          <input type="text" class="form-control" required placeholder="000.000.000-00" id="cpfUsuarioPessoaFisica"
                                                maxlength="14" autocomplete="off" autofocus>
                              ...
                              <div class="col-md-6">
                                    <!-- Senha -->
                                    <div class="md-form">
                                          <input type="password" minlength="6" maxlength="15" required id="senhaUsuarioPessoaFisica" class="form-control">
                        ...
                        <div class="text-center float-right col-md-6 d-block small mt-2">
                              <a href="index.php" type="button" class="btn btn-info btn-block btn-md" id="btnLoginRegisterPessoaFisica">Voltar ao início&nbsp;&nbsp;
                              </a>
                        </div>
                  </div>
