            ...
            <div class="card-body pt-0">
                ...
                <div class="my-2 p-j">
                    ...
                    <!--<script>
                        function validarSenha(){
                            senha = document.cadastroEmpresa.senha.value;
                            repetirSenha = document.cadastroEmpresa.repetirSenha.value;
                ...
                <form class="text-center" action="#" method="POST" name="cadastroEmpresa" onsubmit="return validarSenha();" style="color: #aaa;">
                    ...
                    <div class="text-center float-right col-md-6 d-block small mt-2">
                        <a class="btn btn-info btn-block btn-md" name="btnLoginPj" href="loginPessoaJuridica.php">Já possui conta?</a>
