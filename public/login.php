    ...
    <div class="card">
        ...
        <div class="card-body px-lg-5 pt-0">
            ...
            <form class="text-center" action="#" method="POST" style="color: #aaa;">
                ...
                <div class="text-center float-right col-md-4 d-block small mt-2">
                    <a href="forgot-password.php" type="button" class="btn btn-link btn-block btn-md" id="btnRecuperarSenha">
                        <p class="blue-text font-weight-bold">Esqueci minha senha</p></a>
