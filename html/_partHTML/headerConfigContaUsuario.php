        ...
        <ul class="custom-scrollbar list-unstyled scrollbar scrollbar-cyan">
            ...
            <li>
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="waves-effect arrow-r" href="configContaUsuario.php">
                    ...
                    <li>
                        <a class="waves-effect arrow-r" href="mercado-favorito.php">
                    ...
                    <li>
                        <a class="waves-effect arrow-r" href="produto-list.php">
                            <i class="fas fa-heart fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Produtos favoritos
                        </a>
                    </li>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-cyan hidden-sn d-print-block">
        ...
        <form class="search-form form-inline mr-auto ml-auto mr-md-auto my-2 my-md-0" role="search" method="POST" action="index.php"
            ...
            <div class="input-group waves-dark">
                <input type="search" class="form-control mr-sm-5 ml-auto mr-0 mr-md-auto my-4 my-md-2" id="input-pesq" size="80px" placeholder="Pesquisar aqui..."
                        aria-label="Search" aria-describedby="basic-addon2" style="height: 3.5rem;">
            </div>
        </form>
        <!-- Dropdown Menu Conta -->
        <ol class="navbar-nav ml-auto ml-md-0 dropdown-backdrop">
            <li class="nav-item dropdown no-arrow mx-1">
                <a class="nav-link mr-md-3" href="#" id="accountDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="far fa-user fa-lg"></i></a>
