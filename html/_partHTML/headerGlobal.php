                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header waves-effect arrow-r">
                            <i class="fas fa-broom fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Limpeza<i class="fa fa-angle-down rotate-icon"></i>
                        </a>
                    ...
                    <li>
                        <a class="collapsible-header waves-effect arrow-r">
                            <i class="fas fa-cookie-bite fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alimentação<i class="fa fa-angle-down rotate-icon"></i>
                        </a>
                        <div class="collapsible-body">
                            <ul class="list-unstyled">
                    ...
                    <li>
                        <a class="collapsible-header waves-effect arrow-r">
                            <i class="fas fa-drumstick-bite fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Carnes<i class="fa fa-angle-down rotate-icon"></i>
                        </a>
                        <div class="collapsible-body">
                            <ul class="list-unstyled">
                    ...
                    <li>
                        <a class="collapsible-header waves-effect arrow-r">
                            <i class="fa fa-beer fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bebidas<i class="fa fa-angle-down rotate-icon"></i>
                        </a>
                        <div class="collapsible-body">
                            <ul class="list-unstyled">
